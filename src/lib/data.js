...
export const Projects = [
  {
    ...
    status: "Live",
    image: "/images/big-photo-hunt.png",
    liveUrl: "https://www.bigphotohunt.com/",
  },
  {
    ...
    status: "In Progress",
    image: "/images/premium-tranfer.png",
  },
  {
    name: "Social Media Dashboard",
    description: "Full-featured socsial platform with authentication, posts, comments, and analytics",
    tech: "Next.js, Express, PostgreSQL, Redis, Docker",
    status: "Completed",
    image: "/images/tveed.png",
    liveUrl: "https://dev.teevd.com/",
  },
  {
    ...
    status: "Live",
    image: "/images/green_planks.png",
    liveUrl: "https://greenplank.eu/",
  },
  {
  ...
  },
  {
    ...
    status: "Live",
    image: "/images/iv.png",
    liveUrl: "https://profectia-the-ai-saas-application.vercel.app/",
  },
];
...
export const skillCategories = [
  {
    ...
    skills: [
      { name: "React.js & Next.js", level: 95, experience: "2+ years" },
      { name: "TypeScript & JavaScript", level: 90, experience: "2+ years" },
      { name: "Tailwind CSS & Material-UI", level: 92, experience: "2+ years" },
      { name: "Redux & State Management", level: 88, experience: "1.5+ years" },
      { name: "Responsive Design", level: 94, experience: "2+ years" },
  ...
  },
  {
    ...
    skills: [
      { name: "Node.js & Express.js", level: 92, experience: "2+ years" },
      { name: "RESTful APIs & GraphQL", level: 88, experience: "1.5+ years" },
      { name: "Authentication & Authorization", level: 90, experience: "2+ years" },
      { name: "Database Design", level: 87, experience: "1.5+ years" },
      { name: "Microservices Architecture", level: 82, experience: "1+ year" },
      { name: "Socket.io & WebSockets", level: 84, experience: "1+ year" },
    ],
    icon: Server,
  ...
  },
  {
    title: "Databases",
    skills: [
      { name: "MongoDB & Mongoose", level: 93, experience: "2+ years" },
      { name: "PostgreSQL & MySQL", level: 89, experience: "1.5+ years" },
      { name: "Redis (Caching)", level: 81, experience: "1+ year" },
      { name: "Prisma ORM", level: 86, experience: "1+ year" },
      { name: "Database Optimization", level: 83, experience: "1+ year" },
      { name: "Data Modeling", level: 88, experience: "1.5+ years" },
    ],
    icon: Database,
  ...
  },
  {
    title: "DevOps & Cloud",
    skills: [
      { name: "Docker & Containerization", level: 82, experience: "1+ year" },
      { name: "AWS (EC2, S3, Lambda)", level: 79, experience: "8+ months" },
      { name: "CI/CD Pipelines", level: 80, experience: "1+ year" },
      { name: "Git & Version Control", level: 94, experience: "2+ years" },
      { name: "Nginx & Deployment", level: 81, experience: "1+ year" },
      { name: "Linux/Ubuntu Server", level: 85, experience: "1.5+ years" },
    ],
    icon: Cloud,
