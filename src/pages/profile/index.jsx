...
const ProfileSlider = () => {
  ...
  return (
    <section className="w-full bg-[#00362E] py-12">
      <div className="max-w-6xl mx-auto lg:px-6 px-3 relative">
        {/* ================= DESKTOP HEADING (UNCHANGED) ================= */}
        <div className="hidden lg:flex flex-col gap-2 absolute -top-5 text-center z-10">
                  ...
                  <div className="flex items-center justify-between mt-6">
                    <div className="flex items-center gap-4">
                      <img
                        src={t.avatar}
                        alt={t.name}
                        className="lg:size-[50px] size-[72px] lg:rounded-full rounded-xl object-cover"
                      />
                      <div className="lg:block hidden">
                        <div className="font-semibold text-white">{t.name}</div>
                        <div className="text-sm text-emerald-200 flex flow-row  gap-2  items-center ">
                          <span>{t.role}</span>
                       ...
                       <div className="lg:hidden block">
                        <div className="font-semibold text-white">{t.name}</div>
                        <div className="text-sm text-emerald-200 flex  flex-col  gap-0  items-start">
                          <span>{t.role}</span>
                          <span className="lg:block hidden">|</span>
                          <a
                            href="#"
        ...
        <div className="lg:hidden flex justify-start gap-4 mt-8">
          <button
            ...
            className={`size-[56px] rounded-full border flex items-center justify-center ${
              activeBtn === "prev"
                ? "bg-white text-black"
                : "border-white text-white"
            }`}
